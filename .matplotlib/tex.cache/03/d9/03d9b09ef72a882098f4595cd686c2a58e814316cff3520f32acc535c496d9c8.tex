...
\IfFileExists{type1ec.sty}{}{\PackageError{matplotlib-support}{Missing cm-super package, required by Matplotlib}{}}
\usepackage{type1cm}
...
{\rmfamily 462 — Ti_overlayer_400nm_in_Red_with_Ir_in_Big}%
\end{document}